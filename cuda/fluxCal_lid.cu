...
namespace
{
  ...
  __global__ void fluxCalculation_kernel(
      ...
      const int discharge_w, const int discharge_h, int32_t *__restrict__ wetMask,uint8_t *__restrict__ landuse,
      const int GREEN_ROOF,
...
void fluxCalculation_cuda(at::Tensor wetMask, at::Tensor lidMask, at::Tensor h_flux,
  ...
  AT_DISPATCH_FLOATING_TYPES(
      h.type(), "fluxCalculation_cuda", ([&]
                                         { fluxCalculation_kernel<scalar_t><<<block_0, thread_0, 0, stream>>>(
                                               ...
                                               wetMask.data<int32_t>(), lidMask.data<uint8_t>(), GREEN_ROOF,
                                               h.data<scalar_t>(), wl.data<scalar_t>(),
