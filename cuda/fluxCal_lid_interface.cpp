...
void fluxCalculation_lid(at::Tensor wetMask,at::Tensor lidMask, at::Tensor h_flux,
  ...
  fluxCalculation_cuda(wetMask,lidMask, h_flux, qx_flux, qy_flux, h, wl, z, qx, qy,
                       index, normal, given_depth, given_q, dx, t, dt);
}

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("addFlux", &fluxCalculation_lid, "fluxCalculation_lid (CUDA)");
}
