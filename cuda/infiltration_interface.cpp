...
void infiltrationAndSewerCalculation(at::Tensor wetMask, at::Tensor h_update,
                             at::Tensor landuse, at::Tensor h,
                             at::Tensor hydraulic_conductivity,
                             at::Tensor capillary_head,
                             at::Tensor water_content_diff,
  ...
  infiltrationAndSewerCalculation_cuda(wetMask, h_update, landuse, h,
                               hydraulic_conductivity, capillary_head,
                               water_content_diff, cumulative_depth, 
                               sewer_sink, dt);
}

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("addInfiltrationAndSewer", &infiltrationAndSewerCalculation,
